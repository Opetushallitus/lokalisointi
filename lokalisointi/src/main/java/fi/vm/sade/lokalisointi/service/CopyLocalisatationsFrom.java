 ...
 * @author mlyly
 */
public class CopyLocalisatationsFrom {

    private static final Logger LOG = LoggerFactory.getLogger(CopyLocalisatationsFrom.class);

    public CopyLocalisatationsFrom() {
        LOG.info("CopyLocalisatationsFrom()");
    }
